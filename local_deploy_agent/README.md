...
2. **Bedrock Model Access** enabled for Claude Sonnet 4.5
3. **Python 3.10+**
...
**Setup:**
1. Follow the [Bedrock Agents Walkthrough](../BEDROCK_AGENTS_WALKTHROUGH.md) to set up:
...
**Learn More:** See the [Bedrock Agents Walkthrough](../BEDROCK_AGENTS_WALKTHROUGH.md) for detailed setup instructions.
...
- [Basic AWS Deployment](../aws_base_agent/) — Simple agent without extra features
- [Full-Featured AWS Deployment](../aws_kb_gr_agent/) — With GuardRails, Knowledge Base, Memory
